...
class FrontierConquestTask(BaseGfTask):
    """
    ...
    def run(self):
        ...
        """
        self.log_info("Starting Frontier Conquest Ranking Screenshot task")
        ...
        self.log_info("Frontier Conquest Ranking Screenshot task completed", notify=True)
        return True
        ...
        try:
            if captured_paths:
                ...
                DiscordNotifier.send_screenshots(
                    captured_paths, "Frontier Conquest Ranking",
