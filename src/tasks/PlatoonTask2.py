...
class PlatoonTask2(BaseGfTask):
    """
    Task that navigates to Platoon → Members, scrolls through the member list,
    and takes screenshots of all members.

    This is a second instance of PlatoonTask to make scheduling easier —
    you can run two platoon screenshot tasks independently.
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.name = "Platoon Members Screenshot 2"
        self.description = (
            "Navigates to Platoon → Members, scrolls the member list, "
            "and screenshots all members. (Second instance). Game must be running (logged in)."
        )
    ...
    def run(self):
        ...
        """
        self.log_info("Starting Platoon Members Screenshot 2 task")
        ...
        self.log_info("Platoon Members Screenshot 2 task completed", notify=True)
        return True
    ...
    def _scroll_and_screenshot_members(self, max_scrolls=30):
        ...
        try:
            ...
            if captured_paths:
                ...
                DiscordNotifier.send_screenshots(captured_paths, "Platoon Members 2")
